...
<div class="showcase-grid">
  ...
  <a class="showcase-card" href="/showcase/2.webp" target="_blank" rel="noreferrer">
    <picture>
      ...
      <img src="/showcase/2.webp" alt="HyprFlux desktop screenshot 2" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  <a class="showcase-card" href="/showcase/3.webp" target="_blank" rel="noreferrer">
    <picture>
      <source srcset="/showcase/3.avif" type="image/avif">
      <img src="/showcase/3.webp" alt="HyprFlux desktop screenshot 3" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  <a class="showcase-card" href="/showcase/4.webp" target="_blank" rel="noreferrer">
    <picture>
      <source srcset="/showcase/4.avif" type="image/avif">
      <img src="/showcase/4.webp" alt="HyprFlux desktop screenshot 4" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  <a class="showcase-card" href="/showcase/5.webp" target="_blank" rel="noreferrer">
    <picture>
      <source srcset="/showcase/5.avif" type="image/avif">
      <img src="/showcase/5.webp" alt="HyprFlux desktop screenshot 5" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  <a class="showcase-card" href="/showcase/6.webp" target="_blank" rel="noreferrer">
    <picture>
      <source srcset="/showcase/6.avif" type="image/avif">
      <img src="/showcase/6.webp" alt="HyprFlux desktop screenshot 6" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  <a class="showcase-card" href="/showcase/8.webp" target="_blank" rel="noreferrer">
    <picture>
      <source srcset="/showcase/8.avif" type="image/avif">
      <img src="/showcase/8.webp" alt="HyprFlux desktop screenshot 8" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
  ...
  <a class="showcase-card" href="/showcase/10.webp" target="_blank" rel="noreferrer">
    <picture>
      ...
      <img src="/showcase/10.webp" alt="HyprFlux desktop screenshot 10" loading="lazy" decoding="async" fetchpriority="low" />
    </picture>
  </a>
</div>
